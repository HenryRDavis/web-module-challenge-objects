...
console.log(lunchSpecial('teacher'));
...
console.log(newRating(reviews, 'Dingus', 3.5, "Tis was delightful, howeva de servich vas very gruesomely bita."));

/* Task 5: Add the following feedback to Reyna's rating - "this place is chill with really cool people, great for getting work done on weekdays"
function*/
function addFeedback(array, feedback){
...
*/
function getLastReview(last) {
   return `${last[last.length-1].name} gave the restaurant a ${last[last.length-1].rating}, and their feedback was: ${last[last.length-1].feedback}`
 } 
...
*/
 ...
 function getReviewByRating(rating) {
  ...
  console.log(getReviewByRating(obj(reviews), 4));
